...
InputData_Bypass.general.time_step_model      = 1/60;   % [min] Base model time step = 1 s
...
% -------------------------------------------------------------------------
InputData_Bypass.general.alfa_min = 0.40;   % [-]
InputData_Bypass.general.alfa_max = 0.40;   % [-]
...
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'DateBegin') && ~isempty(Overrides.DateBegin)
    InputData_Bypass.general.date_begin = Overrides.DateBegin;
end
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'DateEnd') && ~isempty(Overrides.DateEnd)
    InputData_Bypass.general.date_end = Overrides.DateEnd;
end
...
InputData_Bypass.general.record_time_hydrographs       = 1440;     % [min]
...
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'resolution_resample') && ~isempty(Overrides.resolution_resample)
    InputData_Bypass.general.resolution_resample = Overrides.resolution_resample;
end
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'RecordTimeMapsMinutes') && ~isempty(Overrides.RecordTimeMapsMinutes)
    InputData_Bypass.general.record_time_maps = Overrides.RecordTimeMapsMinutes;
    InputData_Bypass.general.record_time_spatial_rainfall = Overrides.RecordTimeMapsMinutes;
end
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'RecordTimeHydrographsMinutes') && ~isempty(Overrides.RecordTimeHydrographsMinutes)
    InputData_Bypass.general.record_time_hydrographs = Overrides.RecordTimeHydrographsMinutes;
end
...
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'UseGPU') && ~isempty(Overrides.UseGPU)
    InputData_Bypass.flags.flag_GPU = double(logical(Overrides.UseGPU));
end
if exist('Overrides','var') && isstruct(Overrides) && isfield(Overrides,'UseSingle') && ~isempty(Overrides.UseSingle)
    InputData_Bypass.flags.flag_single = double(logical(Overrides.UseSingle));
end
...
% The updated input_data_script reads the impervious index explicitly by
% column name when this field is available.
...
%  12) Ks_multiplier_near_surface
%  13) Ks_multiplier_root_zone
%  14) Ks_multiplier_transmission
% ========================================================================
