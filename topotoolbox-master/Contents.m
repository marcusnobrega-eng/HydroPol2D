...
%     INPAINTNANSORDFILT : DEM inpainting using 2D order-statistics filtering
...
%     ISGEOGRAPHIC        : Determines if FLOWobj has a geographic coordinate system
...
%     INTERPSMOOTH        : Interpolate and smooth values measured along a stream network
...
%     ISGEOGRAPHIC        : Determines if STREAMobj has a geographic coordinate system
...
%     PSITRANSFORM        : Psi-transformation of river network elevations
%     QUANTCARVE          : quantile carving
