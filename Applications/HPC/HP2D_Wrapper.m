% HP2D_Wrapper.m
% HydroPol2D SLURM batch wrapper
%
% This file is located in Applications/HPC. It starts the standard model
% launcher from the repository root and writes results to Modeling_Results.
...
%% Fixed paths based on this wrapper location
wrapper_dir      = fileparts(mfilename('fullpath'));
project_root     = fileparts(fileparts(wrapper_dir));
