...
InputData_Bypass.flags.flag_neal_channel                 = 0;
InputData_Bypass.flags.flag_structured_lookup_subgrid    = 0;
InputData_Bypass.flags.flag_voronoi_subgrid              = 0;
...
% Native polygon histories stay internal. These controls define the familiar
% raster, figure, video, and hydrograph package exposed to users.
InputData_Bypass.VoronoiOutput = struct( ...
    'write_native_archive', true, ...
    'native_output_interval_s', 300, ...
    'write_final_geotiffs', true, ...
    'write_temporal_geotiffs', true, ...
    'raster_stack_interval_s', 3600, ...
    'write_figures', true, ...
    'write_videos', true, ...
