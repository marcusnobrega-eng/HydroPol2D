...
config=struct('courant',0.6,'riverbed_hydraulic_conductivity_m_s',1e-6, ...
...
groundwater=make_groundwater(mesh,-1,-10);
...
groundwater=struct('enabled',true,'head',repmat(head,mesh.n_cells,1), ...
