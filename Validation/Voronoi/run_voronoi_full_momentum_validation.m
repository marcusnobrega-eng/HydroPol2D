...
summary=table(lake_error,lake_velocity,high_speed,mass_error,depth_convergence,outlet_convergence, ...
    numel(d),min([d.dt_s]),max([d.dt_s]), ...
    max([d.max_surface_depth_m]),max([d.max_surface_velocity_m_s]), ...
    outlet_volume, ...
    'VariableNames',{'lake_depth_error_m','lake_velocity_m_s','uncapped_velocity_m_s', ...
