...
Cfg = struct();
Cfg.case_id = "VAL-HYDRO-FM-PLANE-001";
...
Cfg = struct();
Cfg.case_id = "VAL-HYDRO-FM-VTILT-001";
...
Cfg = struct();
Cfg.case_id = "VAL-HYDRO-FM-RITTER-001";
...
Cfg = struct();
Cfg.case_id = "VAL-HYDRO-FM-HR-001";
...
Cfg = struct();
Cfg.case_id = "VAL-BC-STAGE-FM-001";
...
exportgraphics(fig, fullfile(fig_dir, 'VAL_HYDRO_FM_PLANE_001.png'), 'Resolution', 200);
close(fig);
...
xlabel('Time (min)');
exportgraphics(fig, fullfile(fig_dir, 'VAL_HYDRO_FM_VTILT_001.png'), 'Resolution', 200);
close(fig);
...
xlabel('x (m)');
exportgraphics(fig, fullfile(fig_dir, 'VAL_HYDRO_FM_RITTER_001.png'), 'Resolution', 200);
close(fig);
...
xlabel('Time (min)'); ylabel('Mass error (%)');
exportgraphics(fig, fullfile(fig_dir, 'VAL_BC_STAGE_FM_001.png'), 'Resolution', 200);
close(fig);
end
