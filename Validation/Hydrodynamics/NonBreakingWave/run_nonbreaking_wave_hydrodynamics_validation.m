...
Cfg = struct();
Cfg.case_id = "VAL-HYDRO-FM-NBW-001";
...
xlabel('Time (min)');
exportgraphics(fig, fullfile(fig_dir, 'VAL_HYDRO_FM_NBW_001_VOLUME.png'), 'Resolution', 200);
close(fig);
...
xlabel('x (m)');
exportgraphics(fig, fullfile(fig_dir, 'VAL_HYDRO_FM_NBW_001_PROFILES.png'), 'Resolution', 200);
close(fig);
end
