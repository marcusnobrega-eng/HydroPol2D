...
Purpose: repeat hydrodynamics validation sequence for HydroPol2D local-inertial and cellular-automata routing after the full-momentum baseline.
...
```matlab
cd HydroPol2D_Model/Validation/Hydrodynamics/LocalInertial_CA
