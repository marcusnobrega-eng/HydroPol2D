...
InputData_Bypass.general.time_step_model      = 0.01/60;   % [min] Base model time step = 5 s
InputData_Bypass.general.min_time_step        = 0.00001;      % [sec] Example minimum adaptive step
...
InputData_Bypass.general.time_step_change     = 0.05;   % [-] Legacy adaptive change factor

% -------------------------------------------------------------------------
% Courant / stability controls
% -------------------------------------------------------------------------
InputData_Bypass.general.alfa_min = 0.30;   % [-]
InputData_Bypass.general.alfa_max = 0.30;   % [-]
...
InputData_Bypass.general.date_end   = datetime(2025,5,1,0,1,0);
...
InputData_Bypass.general.n_outlets_data                = 20;     % legacy default usually 1
InputData_Bypass.general.record_time_maps              = 10/60;    % [min]
InputData_Bypass.general.record_time_hydrographs       = 10/60;     % [min]
