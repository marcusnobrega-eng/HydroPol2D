...
class HighResolutionCaseConfigTests(unittest.TestCase):
    ...
    def test_india_runtime_profile_uses_current_public_flags(self):
        ...
        self.assertIn("HYDROPOL_ENABLE_GROUNDWATER", profile)
        ...
        self.assertIn("timestep_cfl = 0.4", profile)
        self.assertIn("(10 + sqrt(9.81 * 15))", profile)
        self.assertIn("(0.5 + sqrt(9.81 * 0.3))", profile)
