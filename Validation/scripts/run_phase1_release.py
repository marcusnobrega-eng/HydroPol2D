#!/usr/bin/env python3
"""Run the self-contained HydroPol2D Phase 1 release checks.
...
CHECKS = (
    ...
    Check("full momentum", "Validation/Hydrodynamics/FullMomentum_Phase1/run_full_momentum_hydrodynamics_validation.m", "Validation/Hydrodynamics/FullMomentum_Phase1/Outputs/Validation/FullMomentum_Hydrodynamics_Pass_Fail.csv", "full"),
    Check("local inertial and cellular automata", "Validation/Hydrodynamics/LocalInertial_CA_Phase1/run_local_inertial_ca_hydrodynamics_validation.m", "Validation/Hydrodynamics/LocalInertial_CA_Phase1/Outputs/Validation/LocalInertial_CA_Hydrodynamics_Pass_Fail.csv", "full"),
    Check("kinematic and diffusive routing", "Validation/Hydrodynamics/Diffusive_Kinematic_Phase1/run_diffusive_kinematic_hydrodynamics_validation.m", "Validation/Hydrodynamics/Diffusive_Kinematic_Phase1/Outputs/Validation/Diffusive_Kinematic_Hydrodynamics_Pass_Fail.csv", "full"),
    Check("non-breaking wave", "Validation/Hydrodynamics/NonBreakingWave_Phase1/run_nonbreaking_wave_hydrodynamics_validation.m", "Validation/Hydrodynamics/NonBreakingWave_Phase1/Outputs/Validation/NonBreakingWave_Hydrodynamics_Pass_Fail.csv", "full"),
...
def main() -> int:
    ...
    summary = output_dir / "Phase1_Release_Summary.csv"
