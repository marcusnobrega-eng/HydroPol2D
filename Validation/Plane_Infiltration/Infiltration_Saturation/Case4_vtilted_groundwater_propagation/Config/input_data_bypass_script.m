...
InputData_Bypass.general.date_end     = datetime(2025,5,4,0,0,0);
...
SOIL_table.alpha_vg_1_m = [2;0.8;0.8];

SOIL_table.theta_sat = [0.385;0.385;0.385];
SOIL_table.theta_r   = [0.068;0.068;0.068];
SOIL_table.theta_i   = [0.0997;0.0997;0.0997];

% For the local recharge-to-water-table benchmark, use storage coefficient
% consistent with above-residual vadose storage.
SOIL_table.Sy = SOIL_table.theta_sat - SOIL_table.theta_r;

SOIL_table.ksat_gw_mm_h = [1000;1000;1000];

% Updated Case 3 soil/aquifer thickness
SOIL_table.Soil_Depth_m = 0.30 * ones(3,1);
