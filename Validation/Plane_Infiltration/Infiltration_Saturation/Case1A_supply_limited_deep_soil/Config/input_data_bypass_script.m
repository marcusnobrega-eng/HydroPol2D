...
InputData_Bypass.general.date_end   = datetime(2025,5,1,9,0,0);
...
if ~isempty(rainfall_file) && exist(rainfall_file,'file') == 2
    ...
    % ------------------------------------------------------------
    Rainfall_Parameters.time_rainfall      = [0; 12*60]; % [min]
    Rainfall_Parameters.intensity_rainfall = [5;5];      % [mm/h]
    Rainfall_Parameters.time_step_rainfall = 12*60;                      % [min]
    Rainfall_Parameters.rainfall_duration  = 12*60;                     % [min]
    Rainfall_Parameters.n_obs_rainfall     = numel(Rainfall_Parameters.time_rainfall);
end
