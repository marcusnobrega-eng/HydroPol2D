%% V-tilted validation synthetic catchment generator
% Generates static rasters for the shared validation domain.
%
% Run from the repository root:
%   run('HydroPol2D_Model/Validation/VTilted_Catchment/generate_vtilted_domain.m')
...
sgtitle('V-tilted validation Catchment Inputs');
exportgraphics(gcf, fullfile(static_dir, 'overview.png'), 'Resolution', 300);

fprintf('the v-tilted catchment written to:\n%s\n', case_dir);
