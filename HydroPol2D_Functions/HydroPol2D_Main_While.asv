...
clear all
% load workspace_testing.mat
% load workspace_amazon.mat
% load workspace_amazon.mat
load workspace_CG.mat
LULC_Properties.River_K_coeff = 0.1; % River recharge coefficient
flags.flag_subgrid = 0;
flags.flag_baseflow = 1;
flags.flag_critical = 1;
outflow_prev = zeros(size(elevation,1),size(elevation,2),3);
running_control.max_time_step = 30;
flags.flag_dashboard = 0;
flags.flag_CA = 0;
Courant_Parameters.alfa_max = 0.7;
Courant_Parameters.alfa_min = 0.7;
flags.flag_numerical_scheme = 3;
flags.flag_diffusive = 0;
flags.flag_kinematic = 0;
flags.flag_inertial = 1;
flags.flag_subgrid = 0;
flags.flag_baseflow = 0;
format short
