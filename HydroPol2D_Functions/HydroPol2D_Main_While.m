...
while t <= (running_control.routing_time + running_control.min_time_step/60)
    ...
    if running_control.delta_time_save > 0 || k == 1 % First time-step
        if flags.flag_timestep == 0
            ...
            z(depths.d_t < CA_States.depth_tolerance*1000) = 1e12;
