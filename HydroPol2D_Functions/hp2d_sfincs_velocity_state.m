function face = hp2d_sfincs_velocity_state(SubgridTables, zu, direction)
%HP2D_SFINCS_VELOCITY_STATE Query SFINCS velocity-point subgrid tables.
...
switch direction
    ...
    case {'v', 'y'}
        prefix = 'v';
    otherwise
        error('hp2d_sfincs_velocity_state:badDirection', ...
            'direction must be u/x or v/y.');
end

face = query_table_set(SubgridTables, prefix, zu);
end
